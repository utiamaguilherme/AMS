...
<table class="table row-border row-hover compact" id="tickettable">
    ...
    <tr>
        <td><?php echo str_pad($v["cod"], 5, "0", STR_PAD_LEFT); ?></td>
        <td><a href="<?php egetUrl("tickets","listanswer",array("tid"=>$v["id"])) ?>"><?php echo $v["title"]; ?></a></td>
        
        <td><?php echo $v["datacad"]; ?></td>
        <td><?php echo $v["name"]; ?></td>
        <td><?php echo $v["status"]; ?></td>
        <td><?php echo $v["ticketcategories_id"]; ?></td>
        
        <?php if($u["groups_name"]=="admin"){ ?>
        <td style="text-align:right">
            
            <a class="button" role="button" href="<?php egetUrl("tickets","addticket", array("id"=>$v["id"])); ?>">
                <span class="mif-pencil"></span>
            </a> 
            &nbsp; &nbsp; 
            <a class="button" role="button" href="<?php egetUrl("tickets","rmticket", array("id"=>$v["id"])); ?>"
